...
var require_react_dom_client_development = __commonJS((exports) => {
  ...
  (function() {
    ...
    function getNextLanes(root2, wipLanes) {
      ...
      return nextLanes === 0 ? 0 : wipLanes !== 0 && wipLanes !== nextLanes && (wipLanes & suspendedLanes) === 0 && (suspendedLanes = nextLanes & -nextLanes, root2 = wipLanes & -wipLanes, suspendedLanes >= root2 || suspendedLanes === 32 && (root2 & 4194176) !== 0) ? wipLanes : nextLanes;
    }
    ...
    function markRootFinished(root2, finishedLanes, remainingLanes, spawnedLane) {
      ...
      var { expirationTimes, hiddenUpdates } = root2;
    ...
    function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
      ...
      (JSCompiler_object_inline_digest_2310 = didSuspend) || (JSCompiler_object_inline_digest_2310 = current2 !== null && current2.memoizedState === null ? false : (suspenseStackCursor.current & ForceSuspenseFallback) !== 0);
      JSCompiler_object_inline_digest_2310 && (JSCompiler_object_inline_componentStack_2312 = true, workInProgress2.flags &= -129);
      JSCompiler_object_inline_digest_2310 = (workInProgress2.flags & 32) !== 0;
      ...
      if (current2 === null) {
        if (isHydrating) {
          ...
          if (isHydrating) {
            ...
            JSCompiler_temp && (warnNonHydratedInstance(workInProgress2, JSCompiler_object_inline_message_2309), throwOnHydrationMismatch(workInProgress2));
          }
          JSCompiler_object_inline_message_2309 = workInProgress2.memoizedState;
          if (JSCompiler_object_inline_message_2309 !== null && (JSCompiler_object_inline_message_2309 = JSCompiler_object_inline_message_2309.dehydrated, JSCompiler_object_inline_message_2309 !== null))
        ...
        if (JSCompiler_object_inline_componentStack_2312)
          ...
          }, JSCompiler_object_inline_componentStack_2312), JSCompiler_object_inline_stack_2311 = createFiberFromFragment(JSCompiler_object_inline_stack_2311, JSCompiler_object_inline_componentStack_2312, renderLanes2, null), JSCompiler_object_inline_message_2309.return = workInProgress2, JSCompiler_object_inline_stack_2311.return = workInProgress2, JSCompiler_object_inline_message_2309.sibling = JSCompiler_object_inline_stack_2311, workInProgress2.child = JSCompiler_object_inline_message_2309, JSCompiler_object_inline_componentStack_2312 = workInProgress2.child, JSCompiler_object_inline_componentStack_2312.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_componentStack_2312.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2310, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2311;
        pushPrimaryTreeSuspenseHandler(workInProgress2);
        return mountSuspensePrimaryChildren(workInProgress2, JSCompiler_object_inline_message_2309);
      }
      var prevState = current2.memoizedState;
      if (prevState !== null && (JSCompiler_object_inline_message_2309 = prevState.dehydrated, JSCompiler_object_inline_message_2309 !== null)) {
        if (didSuspend)
          workInProgress2.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress2), workInProgress2.flags &= -257, workInProgress2 = retrySuspenseComponentWithoutHydrating(current2, workInProgress2, renderLanes2)) : workInProgress2.memoizedState !== null ? (reuseSuspenseHandlerOnStack(workInProgress2), workInProgress2.child = current2.child, workInProgress2.flags |= 128, workInProgress2 = null) : (reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2312 = JSCompiler_object_inline_stack_2311.fallback, JSCompiler_object_inline_message_2309 = workInProgress2.mode, JSCompiler_object_inline_stack_2311 = mountWorkInProgressOffscreenFiber({
            mode: "visible",
            children: JSCompiler_object_inline_stack_2311.children
          }, JSCompiler_object_inline_message_2309), JSCompiler_object_inline_componentStack_2312 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2312, JSCompiler_object_inline_message_2309, renderLanes2, null), JSCompiler_object_inline_componentStack_2312.flags |= 2, JSCompiler_object_inline_stack_2311.return = workInProgress2, JSCompiler_object_inline_componentStack_2312.return = workInProgress2, JSCompiler_object_inline_stack_2311.sibling = JSCompiler_object_inline_componentStack_2312, workInProgress2.child = JSCompiler_object_inline_stack_2311, reconcileChildFibers(workInProgress2, current2.child, null, renderLanes2), JSCompiler_object_inline_stack_2311 = workInProgress2.child, JSCompiler_object_inline_stack_2311.memoizedState = mountSuspenseOffscreenState(renderLanes2), JSCompiler_object_inline_stack_2311.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2310, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, workInProgress2 = JSCompiler_object_inline_componentStack_2312);
        else if (pushPrimaryTreeSuspenseHandler(workInProgress2), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_message_2309.data === SUSPENSE_FALLBACK_START_DATA) {
          ...
          JSCompiler_object_inline_digest_2310 = JSCompiler_temp === undefined ? null : JSCompiler_temp;
          ...
          typeof JSCompiler_object_inline_digest_2310 === "string" && CapturedStacks.set(JSCompiler_object_inline_componentStack_2312, JSCompiler_object_inline_stack_2311);
        ...
        } else if (didReceiveUpdate || propagateParentContextChanges(current2, workInProgress2, renderLanes2, false), JSCompiler_object_inline_digest_2310 = (renderLanes2 & current2.childLanes) !== 0, didReceiveUpdate || JSCompiler_object_inline_digest_2310) {
          JSCompiler_object_inline_digest_2310 = workInProgressRoot;
          if (JSCompiler_object_inline_digest_2310 !== null) {
            JSCompiler_object_inline_stack_2311 = renderLanes2 & -renderLanes2;
            if ((JSCompiler_object_inline_stack_2311 & 42) !== 0)
            ...
            JSCompiler_object_inline_stack_2311 = (JSCompiler_object_inline_stack_2311 & (JSCompiler_object_inline_digest_2310.suspendedLanes | renderLanes2)) !== 0 ? 0 : JSCompiler_object_inline_stack_2311;
            if (JSCompiler_object_inline_stack_2311 !== 0 && JSCompiler_object_inline_stack_2311 !== prevState.retryLane)
              throw prevState.retryLane = JSCompiler_object_inline_stack_2311, enqueueConcurrentRenderForLane(current2, JSCompiler_object_inline_stack_2311), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2310, current2, JSCompiler_object_inline_stack_2311), SelectiveHydrationException;
          }
          JSCompiler_object_inline_message_2309.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
          workInProgress2 = retrySuspenseComponentWithoutHydrating(current2, workInProgress2, renderLanes2);
        } else
          JSCompiler_object_inline_message_2309.data === SUSPENSE_PENDING_START_DATA ? (workInProgress2.flags |= 128, workInProgress2.child = current2.child, workInProgress2 = retryDehydratedSuspenseBoundary.bind(null, current2), JSCompiler_object_inline_message_2309._reactRetry = workInProgress2, workInProgress2 = null) : (current2 = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_message_2309.nextSibling), hydrationParentFiber = workInProgress2, isHydrating = true, hydrationErrors = null, didSuspendOrErrorDEV = false, hydrationDiffRootDEV = null, rootOrSingletonContext = false, current2 !== null && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current2.id, treeContextOverflow = current2.overflow, treeContextProvider = workInProgress2), workInProgress2 = mountSuspensePrimaryChildren(workInProgress2, JSCompiler_object_inline_stack_2311.children), workInProgress2.flags |= 4096);
        return workInProgress2;
      }
      if (JSCompiler_object_inline_componentStack_2312)
        return reuseSuspenseHandlerOnStack(workInProgress2), JSCompiler_object_inline_componentStack_2312 = JSCompiler_object_inline_stack_2311.fallback, JSCompiler_object_inline_message_2309 = workInProgress2.mode, JSCompiler_temp = current2.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2311 = createWorkInProgress(JSCompiler_temp, {
          mode: "hidden",
          children: JSCompiler_object_inline_stack_2311.children
        }), JSCompiler_object_inline_stack_2311.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, instance !== null ? JSCompiler_object_inline_componentStack_2312 = createWorkInProgress(instance, JSCompiler_object_inline_componentStack_2312) : (JSCompiler_object_inline_componentStack_2312 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2312, JSCompiler_object_inline_message_2309, renderLanes2, null), JSCompiler_object_inline_componentStack_2312.flags |= 2), JSCompiler_object_inline_componentStack_2312.return = workInProgress2, JSCompiler_object_inline_stack_2311.return = workInProgress2, JSCompiler_object_inline_stack_2311.sibling = JSCompiler_object_inline_componentStack_2312, workInProgress2.child = JSCompiler_object_inline_stack_2311, JSCompiler_object_inline_stack_2311 = JSCompiler_object_inline_componentStack_2312, JSCompiler_object_inline_componentStack_2312 = workInProgress2.child, JSCompiler_object_inline_message_2309 = current2.child.memoizedState, JSCompiler_object_inline_message_2309 === null ? JSCompiler_object_inline_message_2309 = mountSuspenseOffscreenState(renderLanes2) : (JSCompiler_temp = JSCompiler_object_inline_message_2309.cachePool, JSCompiler_temp !== null ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? { parent: instance, pool: instance } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2309 = {
          baseLanes: JSCompiler_object_inline_message_2309.baseLanes | renderLanes2,
          cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_componentStack_2312.memoizedState = JSCompiler_object_inline_message_2309, JSCompiler_object_inline_componentStack_2312.childLanes = getRemainingWorkInPrimaryTree(current2, JSCompiler_object_inline_digest_2310, renderLanes2), workInProgress2.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2311;
      pushPrimaryTreeSuspenseHandler(workInProgress2);
      ...
      current2 !== null && (JSCompiler_object_inline_digest_2310 = workInProgress2.deletions, JSCompiler_object_inline_digest_2310 === null ? (workInProgress2.deletions = [current2], workInProgress2.flags |= 16) : JSCompiler_object_inline_digest_2310.push(current2));
    ...
    function scheduleRetryEffect(workInProgress2, retryQueue) {
      ...
      workInProgress2.flags & 16384 && (retryQueue = workInProgress2.tag !== 22 ? claimNextRetryLane() : 536870912, workInProgress2.lanes |= retryQueue);
    }
    ...
    function performWorkOnRoot(root2, lanes, forceSync) {
      ...
      var exitStatus = (forceSync = !forceSync && (lanes & 60) === 0 && (lanes & root2.expiredLanes) === 0) ? renderRootConcurrent(root2, lanes) : renderRootSync(root2, lanes);
        ...
        do {
          if (exitStatus === RootDidNotComplete)
            ...
            a: {
              ...
              if (ReactSharedInternals.actQueue !== null)
                commitRoot(renderWasConcurrent, workInProgressRootRecoverableErrors, workInProgressTransitions, workInProgressRootDidIncludeRecursiveRenderUpdate, workInProgressDeferredLane, workInProgressRootInterleavedUpdatedLanes, workInProgressSuspendedRetryLanes, IMMEDIATE_COMMIT, renderStartTime, 0);
              else {
    ...
    function commitRootWhenReady(root2, finishedWork, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, lanes, spawnedLane, updatedLanes, suspendedRetryLanes, didSkipSuspendedSiblings, suspendedCommitReason, completedRenderStartTime, completedRenderEndTime) {
      ...
      if (didSkipSuspendedSiblings & 8192 || (didSkipSuspendedSiblings & 16785408) === 16785408) {
            ...
            if (workInProgressSuspendedReason !== NotSuspended && workInProgress !== null) {
              ...
              switch (workInProgressSuspendedReason) {
                ...
                default:
                  ...
                  workInProgressSuspendedReason = NotSuspended;
                  workInProgressThrownValue = null;
                  throwAndUnwindWorkLoop(root2, memoizedUpdaters, thrownValue, reason);
              }
            }
            workLoopSync();
            break;
    ...
    function commitRootImpl(root2, recoverableErrors, transitions, didIncludeRenderPhaseUpdate, renderPriorityLevel, spawnedLane) {
      ...
      markRootFinished(root2, didIncludeRenderPhaseUpdate, remainingLanes, spawnedLane);
      ...
      if ((finishedWork.subtreeFlags & 15990) !== 0 || transitions) {
        ...
        injectedProfilingHooks !== null && typeof injectedProfilingHooks.markLayoutEffectsStarted === "function" && injectedProfilingHooks.markLayoutEffectsStarted(didIncludeRenderPhaseUpdate);
          ...
          for (var root2 = firstScheduledRoot;root2 !== null; ) {
            if (!onlyLegacy)
              if (syncTransitionLanes !== 0) {
                ...
                nextLanes = workInProgressRootRenderLanes, nextLanes = getNextLanes(root2, root2 === workInProgressRoot ? nextLanes : 0), (nextLanes & 3) !== 0 && (didPerformSomeWork = true, performSyncWorkOnRoot(root2, nextLanes));
            root2 = root2.next;
          }
...
var levels = {
  ...
  CR: { X: 0, H: 0, M: 0.1, L: 0.2 },
  IR: { X: 0, H: 0, M: 0.1, L: 0.2 },
  AR: { X: 0, H: 0, M: 0.1, L: 0.2 }
};
var maxComposedEQ3 = [
...
// src/cvss/cvss.ts
function parseCVSS40(cvss40, skipPrefix = false) {
  cvss40 = cvss40.trim();
  if (!skipPrefix) {
  ...
  const extractValueMetric = function(metric, metrics, constraint) {
    return extractValueMetricFromMap(metric, metrics, constraint);
  };
  const extractValueMetricOptional = function(metric, metrics, defaultValue, constraint) {
...
function cvss40score(cvss) {
  const macroVectorResult = macroVector(cvss);
  const defaultMetrics = ["VC", "VI", "VA", "SC", "SI", "SA"];
  if (defaultMetrics.every((metric) => cvss[metric] == "N")) {
    return 0;
  }
...
function calcMeanDistance(value, nextLowerMacro, macroVectorResult, currentSeverities, eq6) {
  ...
  const normalizedSeverities = [0, 0, 0, 0, 0].map((norm_serv, i) => {
    if (nextLowerMacro[i] !== undefined) {
      ...
      const maxSeverity = (i != 2 ? maxSeverityData[i][eqi] : maxSeverityeq3eq6[eqi][eq6]) * 0.1;
      const percentToNextEqiSeverity = currentSeverities === undefined ? 0 : currentSeverities[i] / maxSeverity;
      return available_distance_eqi * percentToNextEqiSeverity;
    }
    return norm_serv;
  });
  const meanDistance = nExistingLower == 0 ? 0 : normalizedSeverities.reduce((s, c) => s + c, 0) / nExistingLower;
  return meanDistance;
}
function isOfType(input) {
  return input !== undefined;
}
function calcMaxVectors([eq1, eq2, eq3, eq4, eq5, eq6]) {
...
function getSeverities(cvss, max_vectors) {
  for (let i = 0;i < max_vectors.length; i++) {
    const max_vector = parseCVSS40(max_vectors[i], true);
    ...
    if ([AV, PR, UI, AC, AT, VC, VI, VA, SC, SI, SA, CR, IR, AR].some((met) => met < 0)) {
      continue;
    }
    return [
      AV + PR + UI,
...
function calcScoreEq3eq6NextLowerMacro(eq) {
  ...
  if (eq3 == 1 && eq6 == 1) {
    ...
    if (scoreEq3eq6NextLowerL === undefined || scoreEq3eq6NextLowerR === undefined)
      return;
...
function extractValueMetricFromMap(metric, metrics, constraint) {
...
function extractValueMetricOptionalFromMap(metric, metrics, defaultValue, constraint) {
  if (metrics.has(`M${metric}`)) {
    const r = metrics.get(`M${metric}`);
    metrics.delete(metric);
    if (isOfType(r) && constraint.includes(r)) {
...
function macroVector(cvss) {
  ...
  if (cvss.AV == "N" && cvss.PR == "N" && cvss.UI == "N") {
    eq[0] = 0;
  } else if ((cvss.AV == "N" || cvss.PR == "N" || cvss.UI == "N") && !(cvss.AV == "N" && cvss.PR == "N" && cvss.UI == "N") && !(cvss.AV == "P")) {
    eq[0] = 1;
  } else if (cvss.AV == "P" || !(cvss.AV == "N" || cvss.PR == "N" || cvss.UI == "N")) {
    eq[0] = 2;
  }
  ...
  if (cvss.VC == "H" && cvss.VI == "H") {
    eq[2] = 0;
  } else if (!(cvss.VC == "H" && cvss.VI == "H") && (cvss.VC == "H" || cvss.VI == "H" || cvss.VA == "H")) {
    eq[2] = 1;
  ...
  if (cvss.MSI == "S" || cvss.MSA == "S") {
    eq[3] = 0;
  } else if (cvss.SC == "H" || cvss.SI == "H" || cvss.SA == "H") {
    eq[3] = 1;
  } else {
  ...
  if (cvss.CR == "H" && cvss.VC == "H" || cvss.IR == "H" && cvss.VI == "H" || cvss.AR == "H" && cvss.VA == "H") {
    eq[5] = 0;
  } else if (!(cvss.CR == "H" && cvss.VC == "H" || cvss.IR == "H" && cvss.VI == "H" || cvss.AR == "H" && cvss.VA == "H")) {
    eq[5] = 1;
  }
  return eq;
}
...
var App = () => {
  const [cvssString, setCvssString] = import_react.default.useState("CVSS:4.0/AV:L/AC:L/AT:P/PR:L/UI:N/VC:H/VI:H/VA:H/SC:N/SI:N/SA:N");
  const [score, setScore] = import_react.default.useState(0);
